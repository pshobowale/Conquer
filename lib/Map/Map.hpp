...
public:
  ...
  void ColorizeByPosition(SDL_Renderer* renderer,SDL_FPoint rel_win_pos, SDL_Rect zoom_slice,SDL_Colour color);
  void ColorizeByMapPosition(SDL_Renderer* renderer,SDL_Point position,SDL_Rect zoom_slice, SDL_Color color);
  void ColorizeByID(SDL_Renderer* renderer,unsigned int id, SDL_Color color);
};